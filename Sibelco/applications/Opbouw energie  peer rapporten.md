...
DTS, Kostenplaat, Item, uren, kWh, tonnen, gas
    14. Job Linkworx_DES_Log_Update

Deze scheduled job draait elke 5 minuten en bevat volgende stappen:

16. Import MES (sp_Import_MES)
17. Update Calculation (sp_UpdateCalculations2)
18. Update Peer (sp_UpdatePeer)
19. sp_Import_MES
...
![Exported image](Exported%20image%2020250721194620-0.png)24. sp_UpdateCalculations2

De stored procedure sp_UpdateCalculations2 berekent / update de value_diff van [datalog_energy]

26. [datalog_energy]
![Exported image](Exported%20image%2020250721194624-1.png)28. sp_UpdatePeer
...
32. DateSequence: een tabel met vaste tijdintervallen
33. MES_PRD_Opr
